...
<#
    .SYNOPSIS
    Gets information about the local machine using WMI.
...
$LocationDetails = Get-City -Detailed

$Computer = [PSCustomObject][ordered]@{
    Updated = (Get-Date).Date;
    ...
    History = (New-Object -TypeName System.Collections.ObjectModel.Collection[PSObject]);
    }
